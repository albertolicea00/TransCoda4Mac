...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/FFmpeg-powered-009AD8?logo=ffmpeg" alt="FFmpeg"/>
...
SF Symbols, native toolbar, drag & drop straight from Finder. 🖥️✨
...
- 🎞️ **Video codecs:** H.264/AVC, H.265/HEVC, AV1, VP9.
...
```
┌─────────────────────────────┐
│  SwiftUI 🖥️                │  queue list, drag & drop, inspector settings
├─────────────────────────────┤
...
them in this order: bundled inside the app → Homebrew/MacPorts locations → `PATH`.
...
AV1 encoding uses `libsvtav1`, included in the standard Homebrew build.
...
a sandboxed App Store profile is future work. 🏗️
